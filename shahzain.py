...
""",
    "message":"Why You Are @!\n╔═════════════════════\nᵀᴴᴬᴺᴷˢ ᶠᴼᴿ ᴬᴰᴰ ᴹᴱ\n╚══════════════════════",
    "welmsg":"╔═════════════════════\🔰✯ͥ ͣ ͫ͢Lover༻•y\n╚══════════════════════",
    "leftmsg":"╔═════════════════════\🔰✯ͥ ͣ ͫ͢Lover༻•\n╚══════════════════════",
    "tagteks1":"Lover is here😜",
    "tagteks2":"1% club",
    "tagteks3":"Love//-.."
	}
...
""")
        if op.type == 25:
            ...
            if msg.text in ["Lover"]:
                if msg.toType == 2:
                    dz.sendMessage(msg.to,"🔰✯ͥ ͣ ͫ͢Lover༻🔰")
...
#=================================================
                ...
                for i in gid:
                  ...
                  if h == ng:
                    ...
                    dz.sendMessage(i,"ᴀᴜᴛᴏ sɪᴅᴇʀ ʙʏ: ✯ͥ ͣ ͫ͢Lover༻࿐")
                    pro["prosider"][i] = True
                    with open('pro.json', 'w') as fp:
                        json.dump(pro, fp, sort_keys=True, indent=4)
                    try:
